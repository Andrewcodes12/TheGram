...
def seed_posts():
    ...
    post12 = Post(userId=2, photoUrl='https://mymodernmet.com/wp/wp-content/uploads/2019/07/will-burrard-lucas-beetlecam-23-1024x683.jpg',
                  caption='Really cool', likes=1, created_at=f'{now}')
